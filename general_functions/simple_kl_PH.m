function [EW, lambdas, probs, probs2, cumProbs, error] = simple_kl_PH(d,lambda,SCV,f,k_PH,Delta,Bsize,r,k_indxs, l_indxs, greater, greater_or_eq, tol, lambdas)
% lambda : arrival rate
...
EX=1;
[alpha, A, mu, ~] = hyper_erlang_init(EX, SCV, f, k_PH);
